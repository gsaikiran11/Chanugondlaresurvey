...
lyr_LinkedwithDLR_3.set('fieldLabels', {'LPM_NO': 'inline label - always visible', 'Corelation': 'inline label - always visible', 'Ac.Cts': 'inline label - always visible', 'Hc.Cts': 'hidden field', 'Land Natur': 'inline label - always visible', 'Land Nat_1': 'hidden field', 'Land Class': 'inline label - always visible', 'Land Cla_1': 'hidden field', 'Nature Of': 'hidden field', 'Khata No.': 'inline label - always visible', 'Pattadhar': 'inline label - always visible', 'Pattadha_1': 'inline label - always visible', 'Enjoyment': 'hidden field', });
